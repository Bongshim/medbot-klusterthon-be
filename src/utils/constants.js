...
const defaultMessageTemplates = [
  ...
  },
  {
    messageTemplate: {
      ...
      emailBody:
        'Dear {{firstName}}, To reset your password, click on this link: https://stuternmedbot.netlify.app/auth/forgot-password/reset?token={{token}} If you did not request any password resets, then ignore this email.',
