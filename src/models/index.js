...
const { SymptomCause } = require('./symptomCause.model');
...
exports.association = () => {
  ...
  // Symptoms - Symptom Cause
  Symptoms.hasMany(SymptomCause, { foreignKey: 'symptomId' });
  SymptomCause.belongsTo(Symptoms, { foreignKey: 'symptomId' });
};
